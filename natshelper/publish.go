...
// NatsPublish publishes a message to a NATS subject with OpenTelemetry tracing.
...
//	}
//	err = natshelper.NatsPublish(context.Background(), nc, "my.subject", []byte("Hello, World!"))
//	if err != nil {
//	    log.Fatalf("Failed to publish message: %v", err)
//	}
func NatsPublish(ctx context.Context, nc *nats.Conn, subj string, data []byte) error {
